...
python nnds_training.py --neural-tool snds --motion-shape Multi_Models_1 --relaxed --num-epochs 50 --gpu&
python nnds_training.py --neural-tool snds --motion-shape Multi_Models_2 --relaxed --num-epochs 50 --gpu&
python nnds_training.py --neural-tool snds --motion-shape Multi_Models_3 --relaxed --num-epochs 50 --gpu&
python nnds_training.py --neural-tool snds --motion-shape Multi_Models_4 --relaxed --num-epochs 50 --gpu

python nnds_training.py --neural-tool snds --motion-shape Multi_Models_1 --relaxed --num-epochs 5000 --gpu&
python nnds_training.py --neural-tool snds --motion-shape Multi_Models_2 --relaxed --num-epochs 5000 --gpu&
python nnds_training.py --neural-tool snds --motion-shape Multi_Models_3 --relaxed --num-epochs 5000 --gpu&
python nnds_training.py --neural-tool snds --motion-shape Multi_Models_4 --relaxed --num-epochs 5000 --gpu&
